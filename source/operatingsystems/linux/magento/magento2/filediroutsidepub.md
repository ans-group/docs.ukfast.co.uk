...
You need to edit replacemebackend with the PHP-FPM configuration pool name (This should be defined at the top of your Nginx configuration file). You also need to add info to the .php file whitelist, we have a guide for this [here](https://docs.ukfast.co.uk/operatingsystems/linux/magento/magento2/nginxphpfilewhitelist.html)
