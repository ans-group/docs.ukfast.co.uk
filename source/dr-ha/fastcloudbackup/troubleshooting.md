...
You should not use this to add new computers or servers to be backed up - instead follow the instructions shown on [Setting up the FASTcloudbackup agent](installing_the_fastcloudbackup_agent) - this will guide you through installing the agent so you can run and manage backups.
...
When installing the FASTcloudbackup agent, a Migration Assistant will also be added to your computer or server.  However you should not use this to complete the installation or setup process.  Simply follow the instructions in [Setting up the FASTcloudbackup agent](installing_the_fastcloudbackup_agent).
