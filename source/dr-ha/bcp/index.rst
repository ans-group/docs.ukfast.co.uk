...
The Business Continuity Platform (or "BCP" / "cluster") is a highly-available configuration of `Linux </operatingsystems/linux/index.html>`_ servers, allowing for failover in the event of a node going offline and for balancing workloads across more than one server when all members are operational.
