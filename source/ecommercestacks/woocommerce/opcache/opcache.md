...
You can then browse www.woocommercedomain.com/opcache-gui. We recommend password/ip redirection for this URI, we have guides on how to do this [here](https://docs.ukfast.co.uk/operatingsystems/linux/magento/magento2/restrictfilefolder.html)
