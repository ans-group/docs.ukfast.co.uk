...
If you have PHP already installed and would like to take a backup of the configuration files, you can run the following commands:

```eval_rst
.. note:: You can copy and paste the whole block below into your SSH terminal
```
...
This includes the PHP modules required by Shopware.
...
You can find more information on OPcache [here](/ecommercestacks/shopware/opcache/opcache)
...
You can find more information on APCu [here](/ecommercestacks/shopware/apcu/apcu)
