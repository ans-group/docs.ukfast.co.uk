...
You will now be able to view a list of currently connected users as below, right clicking on any particular user, reveals a a number of options which are explained below, you can also pop out the arrow next to each user to view which processes they are currently using.
...
* Sign Off - Disconnects the clients session and closes all open applications/documents.
