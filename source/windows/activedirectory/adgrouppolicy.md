...
* In a Domain Environment, it is posible to manipulate Computer configuration and user priviledges for specified groups of users and computers, 
  ...
  The Group Policy objects can be assigned to groups of Users and/or groups of computers to control the user enviroment and computer behaviour rather than configuring permissions on each computer for each user.
