...
.. seealso::
   ...
   To use DDoSX\ :sup:`®`, CDN and WAF from UKFast, you need to have your domains' nameservers pointing to the UKFast nameservers. In order to do this you will either have to be hosting your domains with UKFast's safeDNS or set up a CNAME.
