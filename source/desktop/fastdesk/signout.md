# Signing out of your FastDesk Desktop

## Signing out and disconnecting, what's the difference?

Disconnecting your FastDesk Desktop is a convenient way of leaving your session on standby. Signing out completely ends the session so when you log in, nothing has been left open from your previous session. Disconnecting leaves everything running on your desktop so you can connect in later (Perhaps from a different device) and still find your apps and files open as you left them. 

Whenever you disconnect, your session is still active in the background and therefore, you will not benefit from some of the changes or polices that are applied to your FastDesk whilst your session is in its current state.  You can opt to disconnect your FastDesk if you are leaving your desktop for a short period of time. For anything longer than a couple of hours, we would recommend completely signing out. 

## How do I disconnect?

You can disconnect by simply closing your Citrix Workspace Window or web browser session. Alternatively, you can also diconnect by clicking the disconnect buttion in the start menu.
