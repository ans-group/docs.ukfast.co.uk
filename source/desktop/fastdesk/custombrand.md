...
1. The domain name of the web page that users access in order to login can be custom branded. Instead of logging in via the `www.fastdesk.co.uk` web page, clients can use their own domain name. This domain can be anything of your choosing and it often relates to the company using the FASTdesk environment.

  The most common domains used are `desktop.companyname.co.uk` or `vdi.companyname.co.uk`.
