...
These pre-requisites are normally installed with Windows updates so if your version of Windows is up to date, you should not have to install these. The Citrix Workspace application also attempts to install them during installation (see Step 1). If none of these steps result in the installation of the pre-requisites, please visit the Citrix help page at:
