...
For more information about removing a load balancer in eCloud Flex, check out our documentation [here](/ecloud/flex/resources/lbaas/deleting_lb_horizon.html).
