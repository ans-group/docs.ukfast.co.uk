...
If you're using SafeDNS from UKFast, follow the steps in [this article](/Domains/safedns/addnewdomain.md) to add your domain, along with the IP address you wish to point the domain to.  Repeat this for each of the domain.
